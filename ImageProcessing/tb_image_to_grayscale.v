...
module tb_image_to_grayscale;
    ...
    initial begin
        ...
        // B. Mở file
        f_in  = $fopen("D:/CE213/TH/ImageProcessing/baitap2_pic_input.txt", "r"); // File do Python tạo
        f_out = $fopen("D:/CE213/TH/ImageProcessing/baitap2_pic_output.txt", "w"); // File để Python đọc lại
