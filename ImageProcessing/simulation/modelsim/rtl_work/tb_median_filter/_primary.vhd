...
entity tb_median_filter is
    generic(
        ...
        HEIGHT          : integer := 554;
        SIZE            : vl_notype;
        USE_DECIMAL     : integer := 1;
        INPUT_PATH      : string  := "D:/CE213/TH/ImageProcessing/pic_input.txt";
        OUTPUT_PATH     : string  := "D:/CE213/TH/ImageProcessing/pic_output.txt"
    );
    ...
    attribute mti_svvh_generic_type of USE_DECIMAL : constant is 1;
